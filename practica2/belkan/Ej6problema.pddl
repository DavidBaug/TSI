...
(define (problem ejercicio1-problema2)
  ...
  (:objects
      ...
      zapatillas bikini - objeto
      Princesa Principe Bruja Profesor LeonardoDiCaprio - personaje
      HarryPotter Voldemort - jugador
      Agua Bosque Precipicio Arena Piedra - tipo
      mochila1 mochila2 - mochila
  )
  (:init
    ...
    (tipoZona z14 Agua)
    (tipoZona z15 Agua)
    (tipoZona z16 Precipicio)
    (tipoZona z17 Arena)
    (tipoZona z18 Piedra)
    (tipoZona z19 Agua)
    (tipoZona z20 Precipicio)
    (tipoZona z21 Bosque)
    (tipoZona z22 Bosque)
    (tipoZona z23 Piedra)
    (tipoZona z24 Piedra)
  ...
  ;(:metric maximice (puntos HarryPotter))
  (:goal (AND (= (puntos HarryPotter) 20) (= (puntos Voldemort)20))
  )
)
